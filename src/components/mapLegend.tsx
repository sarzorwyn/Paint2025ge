...
const legendDiv = ({partySeats}) => (<div id="legend" className='bg-white rounded-md  bottom-4 absolute left-auto sm:bottom-8 right-2.5 sm:shadow-md text-xs font-sans p-2 z-10' >
...
const MapLegend = ({partySeats}) => {return ((partySeats.size > 0) && legendDiv({partySeats}))}
